...
#line 107 "c_parser.tab.c" /* yacc.c:355  */
...
#line 152 "c_parser.tab.c" /* yacc.c:355  */
};
...
{
  "$end", "error", "$undefined", "COMMA", "LCURLY", "RCURLY", "SEMICN",
  "EQUOP", "LBKT", "RBKT", "DATA_TYPE", "ID", "RETURN", "ADDOP", "MUNISOP",
  "MULTIOP", "DIVOP", "FUN_ENTRY", "NUM", "$accept", "START", YY_NULLPTR
};
#endif
...
#line 1239 "c_parser.tab.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 102 "c_parser.y" /* yacc.c:1906  */
